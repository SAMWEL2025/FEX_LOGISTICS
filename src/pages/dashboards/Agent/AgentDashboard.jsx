...
import AgentShipments from './Shipments/AgentShipments';
import UpdateTracking from './Shipments/UpdateTracking';
...
const AgentDashboard = () => {
  ...
  const [notifications, setNotifications] = useState([
    { id: 1, type: 'info', title: 'New Feature Available', message: 'You can now update tracking in real-time', time: '2 hours ago' },
  ...
  const getActiveTab = () => {
    ...
    if (path.includes('/shipments') && !path.includes('/tracking')) return 'shipments';
  ...
  const getTabTitle = () => {
    switch(activeTab) {
      ...
      case 'tracking': return 'Update Tracking';
  ...
  const DashboardHome = () => {
    ...
    const recentShipments = [
      { id: 'AG12345', origin: 'Lagos', destination: 'Abuja', status: 'In Transit', date: '2023-05-15' },
      { id: 'AG67890', origin: 'Port Harcourt', destination: 'Kano', status: 'Delivered', date: '2023-05-10' },
      { id: 'AG24680', origin: 'Abuja', destination: 'Enugu', status: 'Pending', date: '2023-05-18' }
    ];
      ...
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
          ...
          >
            ...
            <div>
              <h3 className="text-lg font-semibold">Manage Shipments</h3>
              <p className="text-gray-600">View and manage all shipments</p>
            </div>
          </Link>
          
          <Link 
            to="/dashboard/agent/tracking" 
            className="bg-white p-6 rounded-lg shadow flex items-center hover:shadow-md transition-shadow"
          >
            ...
            <div>
              ...
              <p className="text-gray-600">Update shipment tracking info</p>
            </div>
          </Link>
          
          <Link 
            to="/dashboard/agent/notifications" 
            className="bg-white p-6 rounded-lg shadow flex items-center hover:shadow-md transition-shadow"
          >
            ...
            <div>
              ...
              <p className="text-gray-600">View all notifications</p>
            </div>
          </Link>
        </div>
        ...
        <div className="bg-white rounded-lg shadow p-6">
          <div className="flex justify-between items-center mb-6">
            ...
            <Link to="/dashboard/agent/shipments" className="text-red-600 hover:text-red-800">
              View All
            </Link>
          </div>
              ...
              <ul className="space-y-2">
                ...
                <li>
                  <Link 
                    ...
                    onClick={() => setSidebarOpen(false)}
                    className={`w-full text-left px-4 py-3 rounded-lg flex items-center ${
                      activeTab === 'notifications' ? 'bg-red-100 text-red-700' : 'text-gray-700 hover:bg-gray-100'
                    }`}
                  >
