...
const EcommerceDashboard = () => {
  ...
  const handleTrackingClick = () => {
    navigate('/dashboard/ecommerce/shipment-history');
  ...
  const getActiveTab = () => {
    ...
    if (path.includes('/shipment-history')) return 'shipments';
    if (path.includes('/book-shipment')) return 'new-shipment';
    return 'dashboard';
  };
  ...
  const getTabTitle = () => {
    switch(activeTab) {
      ...
      case 'new-shipment': return 'Book Shipment';
  ...
  const DashboardHome = () => {
    ...
    const recentShipments = [
      { id: 'EC12345', origin: 'Lagos', destination: 'Abuja', status: 'In Transit', date: '2023-05-15' },
      { id: 'EC12346', origin: 'Port Harcourt', destination: 'Kano', status: 'Delivered', date: '2023-05-10' },
      { id: 'EC12347', origin: 'Abuja', destination: 'Enugu', status: 'Pending', date: '2023-05-18' }
    ];
    ...
    return (
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
          <Link 
            to="/dashboard/ecommerce/shipment-history" 
          ...
          >
            ...
            <div>
              ...
              <p className="text-gray-600">View all your shipments</p>
            </div>
          </Link>
          
          <Link 
            to="/dashboard/ecommerce/book-shipment" 
            className="bg-white p-6 rounded-lg shadow flex items-center hover:shadow-md transition-shadow"
          >
            ...
            <div>
              ...
              <p className="text-gray-600">Create a new shipment</p>
            </div>
          </Link>
        ...
        <div className="bg-white rounded-lg shadow p-6">
          <div className="flex justify-between items-center mb-6">
            ...
            <Link to="/dashboard/ecommerce/shipment-history" className="text-red-600 hover:text-red-800">
              View All
            </Link>
          </div>
            ...
            <div className="p-4 border-b border-gray-200">
              <div className="flex items-center">
                <div className="w-10 h-10 rounded-full bg-red-100 flex items-center justify-center mr-3">
                  <FontAwesomeIcon icon={faShoppingCart} className="text-red-600 text-xl" />
                </div>
                <div>
