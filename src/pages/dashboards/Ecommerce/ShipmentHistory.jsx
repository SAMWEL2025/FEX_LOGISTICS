...
const ShipmentHistory = () => {
  ...
  const handleViewTracking = (shipmentId) => {
    navigate(`/dashboard/ecommerce/shipment-history/${shipmentId}`);
  };
        ...
        <div className="max-w-7xl mx-auto px-4 py-6 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div>
              ...
              <p className="mt-1 text-sm text-gray-600">Track and manage all your ecommerce shipments</p>
            </div>
          ...
          <div className="bg-white rounded-lg shadow p-8 text-center">
            <div className="flex justify-center mb-4">
              <div className="w-16 h-16 rounded-full bg-red-100 flex items-center justify-center">
                <FontAwesomeIcon icon={faShoppingCart} className="text-red-500 text-2xl" />
              </div>
            </div>
